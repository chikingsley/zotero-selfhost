...
compatibility.get(
  "/groups/:groupID/collections/:collectionKey/items/top/tags",
  async (c) => {
...
compatibility.get(
  "/groups/:groupID/collections/:collectionKey/items/tags",
  async (c) => {
    const groupID = parseNumericID(c.req.param("groupID"));
    if (groupID === null) {
      return c.text("Invalid groupID", 400);
...
compatibility.get(
  "/users/:userID/collections/:collectionKey/items/top/tags",
  async (c) => {
...
compatibility.get(
  "/users/:userID/collections/:collectionKey/items/tags",
  async (c) => {
    const userID = parseNumericID(c.req.param("userID"));
    if (userID === null) {
      return c.text("Invalid userID", 400);
